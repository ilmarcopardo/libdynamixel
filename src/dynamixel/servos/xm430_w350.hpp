#ifndef DYNAMIXEL_SERVOS_XM430W350_HPP_
#define DYNAMIXEL_SERVOS_XM430W350_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xm430W350 : public Servo<Xm430W350> {
        public:
            typedef Xm430W350 Model;

            Xm430W350(typename protocol_t::id_t id) : Servo<Xm430W350>(id){};

            MODEL_NAME(Xm430W350);
