#ifndef DYNAMIXEL_SERVOS_XM430W250_HPP_
#define DYNAMIXEL_SERVOS_XM430W250_HPP_
...
namespace dynamixel {
    namespace servos {
        ...
        class Xm430W250 : public Servo<Xm430W250> {
        public:
            typedef Xm430W250 Model;

            Xm430W250(typename protocol_t::id_t id) : Servo<Xm430W250>(id){};

            MODEL_NAME(Xm430W250);
